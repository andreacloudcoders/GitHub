...
if($err==0){
	$r = inserisci_cliente($rs,$piva,$citta,$cap,$indirizzo,$prov);
	if($r == 1){
		echo '<META HTTP-EQUIV="Refresh" Content="0; URL=../elimina_cliente.php">';    
   		exit;
	}else{
		echo '<META HTTP-EQUIV="Refresh" Content="0; URL=../nuovo_cliente.php?e=2">';    
   		exit;
	}
}else{
	echo '<META HTTP-EQUIV="Refresh" Content="0; URL=../nuovo_cliente.php?e=1">';    
   	exit;
}
